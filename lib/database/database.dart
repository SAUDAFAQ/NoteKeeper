...
class AppDatabase extends _$AppDatabase {
  ...
  // Future<NoteData> getTitle() async {
  //   return await CustomSelectStatement('SELECT title FROM note WHERE id LIKE 1', variables: [Variable.withInt(1)], tables: Note, _db:note)
  // }
}
